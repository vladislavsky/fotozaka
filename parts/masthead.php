 ...
 */
?>
<header id="masthead" class="site-header" role="banner" style=" background:  url('/wp-content/themes/vantage/images/bg-header.png') repeat-x !important; ">

	<div class="hgroup full-container" style="max-height: 150px; margin: 0 auto; padding:0;">
		<span><a  href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home" class="logo"><?php vantage_display_logo(); ?></a></span>
