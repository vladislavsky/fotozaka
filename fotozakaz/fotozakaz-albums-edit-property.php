<?php
/*
    Template Name: Fotozakaz Albums Edite Property
*/
?>
...
<div id="primary" class="content-area">
   ...
   if ($_POST['submit_save_album']) { save_album($_POST['num_photosession'], $current_user_login);} 
   
     
   list_of_albums($current_user_login, false, true);
