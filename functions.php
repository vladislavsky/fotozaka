...
require_once 'function-fotozakaz.php';


$redirect_to = 'http://www.fotozakaz.com.ua/?page_id=507';
...
function my_login_redirect( $redirect_to, $request, $user ) {
	...
	if ( isset( $user->roles ) && is_array( $user->roles ) ) {
		//check for admins
		if ( 'administrator' == $current_user->roles  || 
			 'contributor' == $current_user->roles  || 
			 'author' == $current_user->roles  || 
			  'editor' == $current_user->roles ) {
			
			return "http://www.fotozakaz.com.ua/?page_id=507";
		} else {
			return "http://www.fotozakaz.com.ua/?page_id=507"/**/;
		}
	} else {
